...
function ct_founder_nav_dropdown_buttons( $item_output, $item, $depth, $args ) {
	...
	if ( 'primary' == $args->theme_location) {
		...
		if( in_array('menu-item-has-children', $item->classes ) || in_array('page_item_has_children', $item->classes ) ) {
			$item_output = str_replace( $args->link_after . '</a>', $args->link_after . '</a><button class="toggle-dropdown" aria-expanded="false"><span class="screen-reader-text">' . __("open child menu", "founder") . '</span></button>', $item_output );
		}
	}
